...
Esta aplicación es un ejemplo de una aplicación Spring Boot con Thymeleaf de cara a un ejemplo de arquitectura básica para una migración de aplicaciones legacy J2EE basadas en patrones MCV a una arquitectura más moderna basada en microservicios y arquitectura hexagonal.
