...
- `sample-geo-front`: Contiene los controladores y las vistas Thymeleaf.
...
# Opcionalmente para el autocompletado de keycloak-js
npm install -D @types/keycloak-js
----

Después arrancaremos el proyecto en modo desarrollo:
